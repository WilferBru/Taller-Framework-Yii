...
class SiteController extends Controller
{
 ...
 public function actionRegister()
 {
  ...
  return $this->render("register", ["model" => $model, "msg" => $msg]);
        ...
        if (Yii::$app->request->post()) {
            ...
            if ((int) $id_alumno) {
                if (Alumnos::deleteAll("id_alumno=:id_alumno", [":id_alumno" => $id_alumno])) {
                    echo "Alumno con id $id_alumno eliminado con exito ";
                    echo "<meta http-equiv='refresh' content='3, ". Url::toRoute("site/view") ."'>";
                }else{
                    echo "A ocurrido un error al eliminar el alumno Redireccionandolo";
                    echo "<meta http-equiv='refresh' content='3, ". Url::toRoute("site/view") ."'>";
                }
            }else{
                echo "A ocurrido un error al eliminar el alumno Redireccionandolo";
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) {
                ...
                if ($table->insert()) {
                    $msg = "Bien echo usuarios guardados";
                    $model->nombre = null;
    ...
    public function actionSaluda($get = "APRENDIENDO YII FRAMEWORK")
    {
        $mensaje = "Hola mundo";
        $numeros = [0, 1, 2, 3, 4];
        return $this->render("saluda", ["mensaje" => $mensaje, "numeros" => $numeros, "get" => $get,]);
    }
    ...
    public function actionRequest()
    {
        ...
        if (isset($_REQUEST["nombre"])) {
            $mensaje = "Excelente, mensaje enviado correctament: " . $_REQUEST["nombre"];
        }
